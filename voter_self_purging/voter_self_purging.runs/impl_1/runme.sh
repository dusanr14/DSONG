...
HD_PWD='C:/Users/Dusan/Desktop/MASTER/Otporni/otporni/fir_otporan/voter_self_purging/voter_self_purging.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log switch_voter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source switch_voter.tcl -notrace
