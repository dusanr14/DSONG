...
HD_PWD='C:/Users/Dusan/Desktop/MASTER/Otporni/otporni/fir_otporan/voter_self_purging/voter_self_purging.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log switch_voter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source switch_voter.tcl
